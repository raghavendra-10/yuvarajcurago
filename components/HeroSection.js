...
export default function HeroSection() {
  const credentials = [
    { label: "MS, DNB, MRCS", desc: "Surgical Gastroenterology" },
    { label: "KEM Hospital", desc: "Mumbai Trained" },
    { label: "10+ Years", desc: "Experience" },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            <p className="text-xl md:text-2xl text-primary-700 mb-4 font-medium">
              Expert in Advanced Laparoscopic & GI Surgery
            </p>

            <p className="text-lg text-primary-600 mb-8 max-w-xl mx-auto lg:mx-0">
              Specialized care for digestive disorders, liver conditions, and GI cancers.
              Trained at KEM Hospital Mumbai with expertise in minimally invasive surgical techniques.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                href="https://wa.me/917021227203?text=Hi%2C%20I%20need%20to%20book%20a%20consultation%20with%20Dr.%20Yuvaraj%2C%20please%20guide%20me"
                className="inline-flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20BA5A] text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
