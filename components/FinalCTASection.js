        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 md:p-12 mb-8 border border-accent-400/30">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="text-center">
              ...
              <div className="text-beige-200">Days of Support</div>
            </div>
            <div className="text-center">
              <svg className="w-12 h-12 mx-auto mb-2 text-accent-400" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-beige-200">Stay connected via WhatsApp</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold mb-2">1</div>
              <div className="text-beige-200">Expert Surgical Gastroenterologist</div>
            </div>
          </div>
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-3 bg-beige-300 hover:bg-beige-400 text-primary-900 font-bold text-xl px-12 py-6 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-beige-300/50"
          >
            <span>Apply for Priority Circle 365</span>
          </button>
