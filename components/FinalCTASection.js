      ...
      <div className="max-w-4xl mx-auto text-center text-white">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 md:p-12 mb-8 border border-accent-400/30">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#20BA5A] text-white font-bold text-xl px-12 py-6 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"
          >
